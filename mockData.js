    ...
    projects: [
      {
        ...
        days: [
          { day: '월', date: '9/7', isoDate: '2026-09-07', progress: 40, slots: [{ startTime: '09:00', endTime: '10:00', summary: '타임시트 입력 UI 와이어프레임 설계', progress: 40 }] },
          { day: '화', date: '9/8', isoDate: '2026-09-08', progress: 60, slots: [{ startTime: '09:00', endTime: '10:00', summary: '타임시트 컴포넌트 구현, AI 보완 버튼 연동', progress: 60 }] },
          { day: '수', date: '9/9', isoDate: '2026-09-09', progress: 68, slots: [{ startTime: '09:00', endTime: '10:00', summary: 'AI 자동 보완 모달 UI 설계', progress: 68 }] },
          { day: '목', date: '9/10', isoDate: '2026-09-10', progress: 78, slots: [{ startTime: '09:00', endTime: '10:00', summary: '다중 프로젝트 아코디언 구현', progress: 78 }] },
          { day: '금', date: '9/11', isoDate: '2026-09-11', progress: 85, slots: [{ startTime: '09:00', endTime: '10:00', summary: '일별 타임라인 뷰 설계 및 QA', progress: 85 }] },
        ],
      },
      {
        ...
        days: [
          { day: '월', date: '9/7', isoDate: '2026-09-07', progress: 10, slots: [{ startTime: '09:00', endTime: '10:00', summary: '알림 API 명세 문서 검토', progress: 10 }] },
          { day: '화', date: '9/8', isoDate: '2026-09-08', progress: 20, slots: [{ startTime: '09:00', endTime: '10:00', summary: '테스트 환경 구성', progress: 20 }] },
          { day: '수', date: '9/9', isoDate: '2026-09-09', progress: 28, slots: [{ startTime: '09:00', endTime: '10:00', summary: '발송 실패 이슈 확인 및 분석', progress: 28 }] },
          { day: '목', date: '9/10', isoDate: '2026-09-10', progress: 38, slots: [{ startTime: '09:00', endTime: '10:00', summary: '재현 테스트 및 백엔드 협의', progress: 38 }] },
          { day: '금', date: '9/11', isoDate: '2026-09-11', progress: 45, slots: [{ startTime: '09:00', endTime: '10:00', summary: '1차 수정안 반영 및 재검증 요청', progress: 45 }] },
        ],
      },
    ],
  },
    ...
    projects: [
      {
        ...
        days: [
          { day: '월', date: '9/7', isoDate: '2026-09-07', progress: 15, slots: [{ startTime: '09:00', endTime: '10:00', summary: '현행 플로우 점검', progress: 15 }] },
          { day: '화', date: '9/8', isoDate: '2026-09-08', progress: 25, slots: [{ startTime: '09:00', endTime: '10:00', summary: '대체 플로우 초안 스케치', progress: 25 }] },
          { day: '수', date: '9/9', isoDate: '2026-09-09', progress: 32, slots: [{ startTime: '09:00', endTime: '10:00', summary: '대체 디자인안 1차 완성', progress: 32 }] },
          { day: '목', date: '9/10', isoDate: '2026-09-10', progress: 40, slots: [{ startTime: '09:00', endTime: '10:00', summary: '개발팀 리뷰 및 피드백 반영', progress: 40 }] },
          { day: '금', date: '9/11', isoDate: '2026-09-11', progress: 45, slots: [{ startTime: '09:00', endTime: '10:00', summary: '최종 수정안 전달', progress: 45 }] },
        ],
      },
      {
        ...
        days: [
          { day: '월', date: '9/7', isoDate: '2026-09-07', progress: 45, slots: [{ startTime: '09:00', endTime: '10:00', summary: '시안 1차 피드백 반영', progress: 45 }] },
          { day: '화', date: '9/8', isoDate: '2026-09-08', progress: 50, slots: [{ startTime: '09:00', endTime: '10:00', summary: '컴포넌트 스타일 정리', progress: 50 }] },
          { day: '수', date: '9/9', isoDate: '2026-09-09', progress: 55, slots: [{ startTime: '09:00', endTime: '10:00', summary: '2차 검토 회의 진행', progress: 55 }] },
          { day: '목', date: '9/10', isoDate: '2026-09-10', progress: 58, slots: [{ startTime: '09:00', endTime: '10:00', summary: '검토 의견 반영', progress: 58 }] },
          { day: '금', date: '9/11', isoDate: '2026-09-11', progress: 60, slots: [{ startTime: '09:00', endTime: '10:00', summary: '최종 시안 정리', progress: 60 }] },
        ],
      },
    ],
  },
    ...
    projects: [
      {
        ...
        days: [
          { day: '월', date: '9/7', isoDate: '2026-09-07', progress: 55, slots: [{ startTime: '09:00', endTime: '10:00', summary: 'API 스펙 초안 작성', progress: 55 }] },
          { day: '화', date: '9/8', isoDate: '2026-09-08', progress: 60, slots: [{ startTime: '09:00', endTime: '10:00', summary: '스펙 리뷰 및 수정', progress: 60 }] },
          { day: '수', date: '9/9', isoDate: '2026-09-09', progress: 65, slots: [{ startTime: '09:00', endTime: '10:00', summary: '엣지 케이스 정의', progress: 65 }] },
          { day: '목', date: '9/10', isoDate: '2026-09-10', progress: 70, slots: [{ startTime: '09:00', endTime: '10:00', summary: '문서 최종 정리', progress: 70 }] },
          { day: '금', date: '9/11', isoDate: '2026-09-11', progress: 72, slots: [{ startTime: '09:00', endTime: '10:00', summary: '스펙 확정, 승인 요청', progress: 72 }] },
        ],
      },
    ],
  },
